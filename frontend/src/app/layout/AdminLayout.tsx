    ...
    <div className="flex min-h-screen bg-[#0a0a0c] text-white">
      ...
      <aside className="fixed top-0 left-0 h-full w-60 bg-[#0a0a0c] border-r border-white/5 flex flex-col z-40">
              ...
              className={({ isActive }) =>
                `flex items-center gap-2.5 px-3 py-2 rounded-md text-xs font-medium transition-colors ${
                  isActive
                    ...
                    : 'text-zinc-500 hover:text-white hover:bg-[#141418]'
                }`
              }
            >
              {item.icon}
        ...
        <div className="px-3 py-4 border-t border-white/5 space-y-1">
          <NavLink
            to="/courses"
            className="flex items-center gap-2.5 px-3 py-2 rounded-md text-xs text-zinc-500 hover:text-white hover:bg-[#141418] transition-colors"
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
