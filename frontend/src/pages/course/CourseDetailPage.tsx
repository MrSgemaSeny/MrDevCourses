  ...
  return (
    <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            {isAdmin ? (
              <span className="px-2.5 py-0.5 rounded text-[10px] font-mono bg-white/10 text-white border border-white/20 flex items-center gap-1.5">
                ...
                <span>Режим администратора &bull; Полный доступ</span>
              </span>
            ) : course.enrolled ? (
              <span className="px-2.5 py-0.5 rounded text-[10px] font-mono bg-white/10 text-white border border-white/20 flex items-center gap-1.5">
          ...
          <div className="pt-3 border-t border-white/5 flex flex-wrap items-center gap-3">
            {isAdmin ? (
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <Link
                  to={`/courses/${course.id}/lessons/${firstAccessible?.id || 1}`}
                  className="px-5 py-2.5 bg-white hover:bg-zinc-200 text-black text-xs font-semibold rounded-sm flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(255,255,255,0.1)] cursor-pointer"
                >
                  <Play className="w-3.5 h-3.5 fill-current" />
                  <span>Смотреть уроки (Администратор)</span>
                </Link>

                <Link
                  to="/admin/curriculum"
                  className="px-4 py-2.5 bg-[#141418] hover:bg-[#1c1c24] border border-white/10 text-zinc-300 hover:text-white text-xs font-medium rounded-sm flex items-center gap-2 transition-colors cursor-pointer"
                >
              ...
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                {isFinished ? (
                  <button
                    ...
                    className="px-5 py-2.5 bg-white hover:bg-zinc-200 text-black text-xs font-semibold rounded-sm flex items-center justify-center gap-2 transition-colors cursor-pointer"
                  >
              ...
              <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
                <button
                  ...
                  className="px-5 py-2.5 bg-white hover:bg-zinc-200 text-black text-xs font-semibold rounded-sm flex items-center justify-center gap-2 transition-all shadow-[0_0_25px_rgba(255,255,255,0.15)] cursor-pointer disabled:opacity-50"
                >
                ...
                <button
                  type="button"
                  onClick={() => setShowTrailerModal(true)}
                  className="px-5 py-2.5 bg-[#141418] hover:bg-[#1c1c24] border border-white/15 text-zinc-200 hover:text-white text-xs font-medium rounded-sm flex items-center justify-center gap-2 transition-colors cursor-pointer"
                >
                  <Play className="w-3.5 h-3.5 fill-current" />
                  <span>Посмотреть видео</span>
                </button>
      ...
      <CourseCurriculumAccordion
        courseId={course.id}
        modules={modules}
        enrolled={isAdmin || course.enrolled}
      />
