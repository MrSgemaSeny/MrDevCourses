    ...
    <div className="w-full max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
      <div className="w-full lg:w-[75%] max-w-[1080px] space-y-8">
        <div className="p-8 rounded-sm bg-[#0e0e11] border border-white/5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] text-center">
          {error ? (
            <div>
              <div className="w-12 h-12 mx-auto mb-4 rounded-full bg-white/10 border border-white/20 flex items-center justify-center text-white">
              ...
              <Link
                to="/courses"
                className="inline-block px-5 py-2.5 rounded-sm bg-white hover:bg-zinc-200 text-xs text-black font-semibold transition-colors font-mono"
              >
                К каталогу курсов
              </Link>
            </div>
            ...
            <div>
              ...
              <span className="px-3 py-1 rounded-full text-[10px] font-semibold bg-white/10 text-white border border-white/20 font-mono">
              ...
              <div className="space-y-3 bg-[#0a0a0c] p-5 rounded-sm border border-white/5 text-left text-xs mb-6 font-mono">
                ...
                <div className="flex justify-between border-b border-white/5 pb-2">
                  ...
                  <span className="font-semibold text-white">{certificate.courseTitle}</span>
                </div>
                <div className="flex justify-between border-b border-white/5 pb-2">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-semibold">100% Завершено</span>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center font-mono">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="px-5 py-2.5 rounded-sm bg-white hover:bg-zinc-200 text-xs font-semibold text-black transition-colors"
                >
