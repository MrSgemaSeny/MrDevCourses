    ...
    <div className="p-5 rounded-sm bg-[#0e0e11] border border-white/5 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)] space-y-5 text-white">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 pb-3 border-b border-white/5">
        ...
        <div className="text-[11px] font-mono text-zinc-400">
          Выполнено шагов: <span className="text-emerald-400 font-bold">{completedStepsCount}</span> из {steps.length}
        </div>
      </div>
          ...
          {steps.map((step) => (
            ...
            >
              ...
              <button
                ...
                className="px-2 py-1 text-[10px] font-mono rounded bg-amber-950/40 hover:bg-amber-900/60 border border-amber-800/60 text-amber-300 flex items-center gap-1 shrink-0 cursor-pointer transition-colors"
                title="Застряли на этом шаге? Отправить сигнал ментору"
              >
