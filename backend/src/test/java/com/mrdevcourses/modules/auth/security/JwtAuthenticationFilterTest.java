...
class JwtAuthenticationFilterTest {
    ...
    @BeforeEach
    void setUp() {
        ReflectionTestUtils.setField(jwtAuthenticationFilter, "cookieName", "mrdevcourses_token");
    ...
    void testFilterWithValidCookie() throws ServletException, IOException {
        ...
        request.setCookies(new Cookie("mrdevcourses_token", "valid-jwt-token"));
    ...
    void testFilterWithInvalidToken() throws ServletException, IOException {
        MockHttpServletRequest request = new MockHttpServletRequest();
        MockHttpServletResponse response = new MockHttpServletResponse();
        request.setCookies(new Cookie("mrdevcourses_token", "invalid-token"));
